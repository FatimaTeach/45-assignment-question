...
var guestList = ["Farheen", "Fatima", "Reshma", "Zanaib", "Faryal", "Osama"];
...
while (guestList.length > 2) {
    var removed_guest = guestList.pop(); // removed the last guest from the list
    console.log("Sorry ".concat(removed_guest, ", \n\"You are no longer invited for dinner\"\n"));
}
