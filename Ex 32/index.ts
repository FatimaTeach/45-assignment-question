...
let current_users=["Fatima", "Faryal", "Kusar", "Kiran", "Afaq"];

let new_users=["Afaq", "Fatima", "Daniyal", "Farheen", "Fabiha"]
//Loop through new users to check for users name avalability

new_users.forEach( new_one_user =>{
    //having a condition for username already existand save in our_condition variables
