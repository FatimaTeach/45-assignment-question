...
// let names = ["Faryal", "kusar", "fatima", "farheen"];
...
//Printing one by one
console.log(`Hey, how are you ? ${names[0]}`); 
console.log(`Hey, how are you ? ${names[1]}`);
console.log(`Hey, how are you ? ${names[2]}`);
console.log(`Hey, how are you ? ${names[3]}`);