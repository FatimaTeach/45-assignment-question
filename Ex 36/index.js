...
function make_shirt(size, printMessage) {
    console.log("\n You selected ".concat(size, " size shirt with ").concat(printMessage, " prints on shirts\n "));
}
make_shirt("Medium", "Work Hard to acheive the goal ");
make_shirt("small", "Fatima");
make_shirt("Large", "Love you Fatima");
