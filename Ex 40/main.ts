...
function make_album(artist_name:string, album_title:string, tracks?:number){
    let album: {artists:string, title:string, tracks?:number} ={
...
//Calling 3 functions with different values and creating 3 variables
let album1 = make_album("Fahad", "Album title 01");

let album2=make_album("Ali", "Album title 02");

//calling a make album function with 3rd parameters
let album3=make_album("Faryad", "Album title 03", 7);

//printing vlues for out objects
console.log(album1)
